...
namespace CarAuction.UnitTests.Controllers
{
    public class BidsControllerTests
    {
        ...
        {
            // Arrange
            var bidIn = new BidInDto { BasePrice = 1000, CarType = "Luxury" };
        ...
        [InlineData(398, "Common", 39.80, 7.96, 5, 100)]
        [InlineData(501, "Common", 50, 10.02, 10, 100)]
        [InlineData(57, "Common", 10, 1.14, 5, 100)]
        [InlineData(1800, "Luxury", 180, 72, 15, 100)]
